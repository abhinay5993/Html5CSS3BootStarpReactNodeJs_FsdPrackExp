 ...
 *
 */
let strProgramArray = ["Java 17", "Python3", "TypeScripts", "JS", "PERL", "Shell"];
console.log("\nShow programmings : " + strProgramArray);
console.log("\nSize of programmings : " + strProgramArray.length);
strProgramArray.forEach((dataItems, indPosition) => console.log(dataItems + " <= array literal items=> " + indPosition));
 ...
 */
let strObjFoodArray = new Array("Pizza", "Cake", "Sandwidtch", "MilkShake", "Idli", "Milk", "Moosz");
console.log("\nShow Foods : " + strObjFoodArray);
console.log("\nSize of Foods : " + strObjFoodArray.length);
strObjFoodArray.forEach((dataItems, indPosition) => console.log(dataItems + " <= Objects => " + indPosition));
...
let strRandomArray = ["Java 17", "", 495, 0.00045, "945.34", "JS", 'd3949', -5, 3.009];
