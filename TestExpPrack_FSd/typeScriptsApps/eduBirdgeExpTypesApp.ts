...
var arrStr:string[] = ["JS", "psu","Ramu","KK"];
for(var stItem in arrStr)
{
console.log("data Items : "+arrStr[stItem]);
}

var numMult:number[][]=[[34,45,39],[39,30,20],[39,303,49]];
for(let i=0;i<numMult.length;i++)
{
    for(let j=0;j<numMult[i].length;j++)
    {
